...
const CheckIconDeprecated: React.FC<SvgProps> = ({fill, ...rest}) => (
  <Svg width="12" height="10" viewBox="0 0 12 10" {...rest}>
    <Path
...
CheckIconDeprecated.defaultProps = {
  width: 12,
  height: 10,
  fill: 'white',
};

export default CheckIconDeprecated;
